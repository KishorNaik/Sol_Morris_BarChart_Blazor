...
namespace MorrisBarChart
{
    public partial class MorrisBarsChart
    {
        #region Declaration
        ...
        private ElementReference DivBarChartElement { get; set; }
        ...
        {
            _module = JSRuntime
                            .InvokeAsync<IJSObjectReference>("import", "./_content/MorrisBarChart/BarChart.js")
                            .AsTask();
        }
        ...
        {
            await (await _module).InvokeVoidAsync(identifier: "drawBarChart", DivBarChartElement, ItemSourceJson, Xkey, YKeysJson, LablesJson);
        }

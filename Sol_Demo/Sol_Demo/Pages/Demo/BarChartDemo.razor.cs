...
using MorrisBarChart;
using Newtonsoft.Json;
using Sol_Demo.Models;

namespace Sol_Demo.Pages.Demo
{
    public partial class BarChartDemo
    {
        #region Private Property

        // Component Referance
        private MorrisBarsChart BarChartM { get; set; }

        private bool IsLoad { get; set; }

        private String BarChartResultSetJson { get; set; }
        ...
        private async Task OnDisplaySalesChart()
        {
            ...
            this.BarChartResultSetJson = JsonConvert.SerializeObject(salesListData);
            this.XKey = "Year";
            ...
            await this.BarChartM.SetBarChartAsync();
        }
